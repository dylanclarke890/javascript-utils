...
export default class FunctionCallPointcut extends Pointcut {
   ...
   * @param {Function} adviceFunc The advice function. A function which receives the parameters
   * of the underlying proxied function before calling it.
   * @return {FunctionCallPointcut} A reference to this instance.
   */
  before(adviceFunc) {
  ...
  /**
   * Shorthand for "around(adviceFn, { flat: true })".
